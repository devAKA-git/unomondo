			...
			success : function (data) { 
				if (data !== '') {
					...
					if (data.slice(0, 6) === 'finish') {
						...
						newHTML = jQuery(data.replace(/cmsms_timeline_type/g, 'cmsms_timeline_type shortcode_animated').replace(/cmsms_masonry_type/g, 'cmsms_masonry_type shortcode_animated'));
					}
