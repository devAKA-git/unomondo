		...
		obj.methods = { 
			...
			setVars : function () { 
				...
				obj.methods.lbHTML = '<div class="cmsmsLightBoxOut">' + 
					'<div class="cmsmsLightBoxBack"></div>' + 
					'<div class="cmsmsLightBoxCont">' + 
						'<div class="cmsmsLightBoxContIn admin-icon-loader animate-spin">' + 
							'<div class="cmsmsLightBoxContInTop wrap"></div>' + 
							'<div class="cmsmsLightBoxContInMid"></div>' + 
							'<div class="cmsmsLightBoxContInBot"></div>' + 
						'</div>' + 
					'</div>' + 
				'</div>';
			}, 
			...
			buildObj : function () { 
				if (obj.methods.options.closeButtons) {
					obj.methods.contInTop.append('<a href="#" class="cmsmsLightBoxClose admin-icon-remove" title="' + obj.methods.options.closeButtonText + '"></a>');
