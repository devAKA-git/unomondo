...
class WP_Widget_Custom_Advertisement extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your advertisement', 'cmsms_content_composer') 
		);
		...
		parent::__construct('custom-advertisement', __('Advertisement', 'cmsms_content_composer'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Advertisement', 'cmsms_content_composer') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title', 'cmsms_content_composer'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('image1')); ?>"><?php _e('Image', 'cmsms_content_composer'); ?> #1:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('link1')); ?>"><?php _e('Link', 'cmsms_content_composer'); ?> #1:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('image2')); ?>"><?php _e('Image', 'cmsms_content_composer'); ?> #2:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('link2')); ?>"><?php _e('Link', 'cmsms_content_composer'); ?> #2:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('image3')); ?>"><?php _e('Image', 'cmsms_content_composer'); ?> #3:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('link3')); ?>"><?php _e('Link', 'cmsms_content_composer'); ?> #3:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('image4')); ?>"><?php _e('Image', 'cmsms_content_composer'); ?> #4:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('link4')); ?>"><?php _e('Link', 'cmsms_content_composer'); ?> #4:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('image5')); ?>"><?php _e('Image', 'cmsms_content_composer'); ?> #5:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('link5')); ?>"><?php _e('Link', 'cmsms_content_composer'); ?> #5:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('image6')); ?>"><?php _e('Image', 'cmsms_content_composer'); ?> #6:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('link6')); ?>"><?php _e('Link', 'cmsms_content_composer'); ?> #6:<br />
...
class WP_Widget_Custom_Divider extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Divider for widgets rows', 'cmsms_content_composer') 
		);
		
		parent::__construct('custom-divider', __('Divider', 'cmsms_content_composer'), $widget_ops);
	}
	...
	function form($instance) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('divider')); ?>"><?php _e('Show Divider Line', 'cmsms_content_composer'); ?></label>
		</p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('divider_bdr')); ?>"><?php _e('Divider Type', 'cmsms_content_composer'); ?>:<br />
				<select class="widefat" id="<?php echo esc_attr($this->get_field_id('divider_bdr')); ?>" name="<?php echo esc_attr($this->get_field_name('divider_bdr')); ?>">
					<option value="solid"<?php if ($divider_bdr == 'solid') { echo ' selected="selected"'; } ?>><?php _e('Solid Line', 'cmsms_content_composer'); ?></option>
					<option value="dashed"<?php if ($divider_bdr == 'dashed') { echo ' selected="selected"'; } ?>><?php _e('Dashed Line', 'cmsms_content_composer'); ?></option>
					<option value="dotted"<?php if ($divider_bdr == 'dotted') { echo ' selected="selected"'; } ?>><?php _e('Dotted Line', 'cmsms_content_composer'); ?></option>
					<option value="transparent"<?php if ($divider_bdr == 'transparent') { echo ' selected="selected"'; } ?>><?php _e('Transparent Line', 'cmsms_content_composer'); ?></option>
				</select>
            </label>
        </p>
		<?php
...
class WP_Widget_Custom_Video extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Video from youtube, vimeo or dailymotion', 'cmsms_content_composer') 
		);
		
		parent::__construct('custom-video', __('Embedded Widget', 'cmsms_content_composer'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Embedded Widget', 'cmsms_content_composer') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php _e('Embed URL', 'cmsms_content_composer'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('url')); ?>" name="<?php echo esc_attr($this->get_field_name('url')); ?>" type="text" value="<?php echo esc_attr($url); ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('width')); ?>"><?php _e('Max Width', 'cmsms_content_composer'); ?>:<br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('height')); ?>"><?php _e('Max Height', 'cmsms_content_composer'); ?>:<br />
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('wrap_embed')); ?>"><?php _e('If checked, ignore default video height/max-height and set a 16:9 proportion instead', 'cmsms_content_composer'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Facebook extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your Facebook like box', 'cmsms_content_composer') 
		);
		
		parent::__construct('custom-facebook', __('Facebook', 'cmsms_content_composer'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Facebook', 'cmsms_content_composer') : $instance['title'], $instance, $this->id_base);
		$url = isset($instance['url']) ? $instance['url'] : '';
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php _e('Facebook Page URL', 'cmsms_content_composer'); ?> :<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('url')); ?>" name="<?php echo esc_attr($this->get_field_name('url')); ?>" type="text" value="<?php echo esc_attr($url); ?>" />
            </label>
        </p>
        <div class="cl"></div>
...
class WP_Widget_Custom_Flickr extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your Flickr account latest images', 'cmsms_content_composer') 
		);
		
		parent::__construct('custom-flickr', __('Flickr', 'cmsms_content_composer'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Flickr', 'cmsms_content_composer') : $instance['title'], $instance, $this->id_base);
		...
		echo '<div class="wrap">' . 
			...
			'</div>' . 
			'<div class="cl"></div>' . 
			'<a href="http://www.flickr.com/photos/' . $user . '" class="more_button" target="_blank"><span>' . __('More flickr images', 'cmsms_content_composer') . '</span></a>' . 
			'</div>' . 
		$after_widget;
	}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('user')); ?>"><?php _e('Flickr ID', 'cmsms_content_composer'); ?> (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):<br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php _e("Enter the number of latest flickr images you'd like to display", 'cmsms_content_composer'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php _e('default is', 'cmsms_content_composer'); ?> 6</small><br />
            </label>
        </p>
        <div class="cl"></div>
        <?php
...
class WP_Widget_Custom_HTML5_Audio extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your HTML5 Audio', 'cmsms_content_composer') 
		);
		...
		parent::__construct('custom-html5-audio', __('HTML5 Audio', 'cmsms_content_composer'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('HTML5 Audio', 'cmsms_content_composer') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('srcmp3')); ?>"><?php echo __('Audio', 'cmsms_content_composer') . ' .mp3 ' . __('File Format URL', 'cmsms_content_composer'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('srcogg')); ?>"><?php echo __('Audio', 'cmsms_content_composer') . ' .ogg ' . __('File Format URL', 'cmsms_content_composer'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('srcwebm')); ?>"><?php echo __('Audio', 'cmsms_content_composer') . ' .webm ' . __('File Format URL', 'cmsms_content_composer'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('preload')); ?>"><?php _e('Preload', 'cmsms_content_composer'); ?>:<br />
				<select class="widefat" id="<?php echo esc_attr($this->get_field_id('preload')); ?>" name="<?php echo esc_attr($this->get_field_name('preload')); ?>">
					<option value="none"<?php if ($preload == 'none') { echo ' selected="selected"'; } ?>><?php _e('Not Preload', 'cmsms_content_composer'); ?></option>
					<option value="auto"<?php if ($preload == 'auto') { echo ' selected="selected"'; } ?>><?php _e('Preload Auto', 'cmsms_content_composer'); ?></option>
					<option value="metadata"<?php if ($preload == 'metadata') { echo ' selected="selected"'; } ?>><?php _e('Preload as Metadata', 'cmsms_content_composer'); ?></option>
				</select>
            </label>
        </p>
		<p class="l_half">
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php _e('Enable Autoplay', 'cmsms_content_composer'); ?></label>
		</p>
		<p class="r_half">
			...
			<label for="<?php echo esc_attr($this->get_field_id('loop')); ?>"><?php _e('Enable Repeat', 'cmsms_content_composer'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_HTML5_Video extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	__('Your HTML5 Video', 'cmsms_content_composer') 
		);
		...
		parent::__construct('custom-html5-video', __('HTML5 Video', 'cmsms_content_composer'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('HTML5 Video', 'cmsms_content_composer') : $instance['title'], $instance, $this->id_base);
        $srcmp4 = isset($instance['srcmp4']) ? $instance['srcmp4'] : '';
        $srcogg = isset($instance['srcogg']) ? $instance['srcogg'] : '';
        $srcwebm = isset($instance['srcwebm']) ? $instance['srcwebm'] : '';
        $poster = isset($instance['poster']) ? $instance['poster'] : '';
        $text = (isset($instance['text']) && $instance['text'] != '') ? $instance['text'] : __('Your browser does not support the video tag.', 'cmsms_content_composer');
        $preload = isset($instance['preload']) ? $instance['preload'] : 'none';
        $loop = isset($instance['loop']) ? $instance['loop'] : false;
        $autoplay = isset($instance['autoplay']) ? $instance['autoplay'] : false;
    ...
    function form($instance) {
		...
		$text = (isset($instance['text']) && $instance['text'] != '') ? esc_attr($instance['text']) : __('Your browser does not support the video tag.', 'cmsms_content_composer');
		$preload = isset($instance['preload']) ? esc_attr($instance['preload']) : 'none';
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('srcmp4')); ?>"><?php echo __('Video', 'cmsms_content_composer') . ' .mp4 ' . __('File Format Source', 'cmsms_content_composer'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('srcogg')); ?>"><?php echo __('Video', 'cmsms_content_composer') . ' .ogg ' . __('File Format Source', 'cmsms_content_composer'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('srcogg')); ?>" name="<?php echo esc_attr($this->get_field_name('srcogg')); ?>" type="text" value="<?php echo esc_attr($srcogg); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('srcwebm')); ?>"><?php echo __('Video', 'cmsms_content_composer') . ' .webm ' . __('File Format Source', 'cmsms_content_composer'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('srcwebm')); ?>" name="<?php echo esc_attr($this->get_field_name('srcwebm')); ?>" type="text" value="<?php echo esc_attr($srcwebm); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('poster')); ?>"><?php _e('Poster URL', 'cmsms_content_composer'); ?>:<br />
...
class WP_Widget_Custom_PayPalDonations extends WP_Widget {
    ...
    public function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr($title_id); ?>"><?php _e('Title:', 'cmsms_content_composer'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($text_id); ?>"><?php _e('Text:', 'cmsms_content_composer'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($purpose_id); ?>"><?php _e('Purpose:', 'cmsms_content_composer'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($reference_id); ?>"><?php _e('Reference:', 'cmsms_content_composer'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($amount_id); ?>"><?php _e('Amount:', 'cmsms_content_composer'); ?> 
		...
		<p>
			<label for="<?php echo esc_attr($button_text_id); ?>"><?php _e('Button Text:', 'cmsms_content_composer'); ?> 
